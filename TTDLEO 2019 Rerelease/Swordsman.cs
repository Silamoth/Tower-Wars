...
// Type: TTDLEO_2019_Rerelease.Swordsman
...
namespace TTDLEO_2019_Rerelease
{
  ...
  {
    public Swordsman(ContentManager content, Vector2 target, Vector2 position)
    {
      this.Target = target;
      ...
      this.Reward = 30;
      this.Speed = 0.8f;
      this.AttackTime = 510f;
      this.Name = nameof (Swordsman);
