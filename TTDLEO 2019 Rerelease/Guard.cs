...
// Type: TTDLEO_2019_Rerelease.Guard
...
namespace TTDLEO_2019_Rerelease
{
  ...
  {
    public Guard(ContentManager content, Vector2 target, Vector2 position)
    {
      this.Target = target;
      ...
      this.Reward = 50;
      this.Speed = 1.3f;
      this.AttackTime = 400f;
      this.Name = nameof (Guard);
      this.LoadSprite(this.Texture, content);
    }

    public override void LoadContent(ContentManager content)
    {
      this.Texture = content.Load<Texture2D>("guardSpritesheet");
    }
  }
}
