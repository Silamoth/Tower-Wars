...
// Type: TTDLEO_2019_Rerelease.Rogue
...
{
  internal class Rogue : Soldier
  {
    public Rogue(ContentManager content, Vector2 target, Vector2 position)
    {
      this.Target = target;
      ...
      this.Reward = 20;
      this.Speed = 1.75f;
      this.AttackTime = 260f;
      this.Name = nameof (Rogue);
      this.LoadSprite(this.Texture, content);
    }

    public override void LoadContent(ContentManager content)
    {
      this.Texture = content.Load<Texture2D>("rogueSpritesheet");
    }
  }
}
