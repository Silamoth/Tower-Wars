...
// Type: TTDLEO_2019_Rerelease.Thief
...
{
  internal class Thief : Soldier
  {
    public Thief(ContentManager content, Vector2 target, Vector2 position)
    {
      this.Target = target;
      ...
      this.Reward = 15;
      this.Speed = 1.55f;
      this.AttackTime = 300f;
      this.Name = nameof (Thief);
      this.LoadSprite(this.Texture, content);
    }

    public override void LoadContent(ContentManager content)
    {
      this.Texture = content.Load<Texture2D>("thiefSpritesheet");
    }
  }
}
